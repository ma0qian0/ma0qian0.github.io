...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'tomma', // 必需
      link: 'https://github.com/ma0qian0', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:tommaqian@gmail.com',
        },
        // {
